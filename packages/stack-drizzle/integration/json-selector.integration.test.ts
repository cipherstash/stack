 ...
 * (`col->'$.age' > 25`) that containment cannot. Equality uses exact
 * value-selector containment; ordering compares the extracted entry with a
 * ciphertext-free scalar query term.
 */
