 ...
 */
export type ProtectAuthErrorCode = 'USAGE_LIMIT_EXCEEDED' | 'ORG_NOT_PROVISIONED' | (string & {});
/**
 ...
 */
export declare function getAuthErrorCode(error: unknown): ProtectAuthErrorCode | undefined;
/**
