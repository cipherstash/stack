...
export type DomainSpec = Readonly<{
  ...
  /**
   * Why the integration matrix does NOT exercise this domain. Absent means it
   * is covered — the common case, so the exclusion is what has to be spelled
   * out, not the inclusion.
   *
   * A deferred domain still needs a row here: the `satisfies Record<…>` below
   * is the coverage mechanism, and dropping the row would hide the domain
   * rather than document why it is skipped. The integration driver reads this
   * field, skips the domain, and prints the reason — so removing coverage is
   * always a visible, reviewable diff, never a silent omission. The unit
   * matrix (`matrix.test.ts`) ignores it and exercises every domain.
   */
  deferred?: string
}>

/**
 * Whether the integration matrix exercises this domain. See {@link DomainSpec.deferred}.
 *
 * Read through these accessors, not by touching `.deferred`: `V3_MATRIX` is
 * `as const`, so a row that omits the field has no such property on its literal
 * type and a direct access does not compile. Widening to `DomainSpec` here makes
 * the optional field readable from every row.
 */
export function isCovered(spec: DomainSpec): boolean {
  return spec.deferred === undefined
}

/** Why the integration matrix skips this domain, or `undefined` if it does not. */
export function deferredReason(spec: DomainSpec): string | undefined {
...
export const V3_MATRIX = {
  ...
  'public.eql_v3_integer': {
    builder: types.Integer,
    ColumnClass: EncryptedIntegerColumn,
    castAs: 'number',
  ...
  'public.eql_v3_integer_eq': {
    builder: types.IntegerEq,
    ColumnClass: EncryptedIntegerEqColumn,
    castAs: 'number',
    capabilities: EQ,
    indexes: UNIQUE_IDX,
    samples: INTEGER_S,
  ...
  'public.eql_v3_integer_ord_ore': {
    builder: types.IntegerOrdOre,
    ColumnClass: EncryptedIntegerOrdOreColumn,
    castAs: 'number',
    capabilities: ORD,
    indexes: ORE_IDX,
    samples: INTEGER_S,
    errorSamples: NUM_ERR,
    deferred: ORE_DEFERRED,
  },
  'public.eql_v3_integer_ord': {
    builder: types.IntegerOrd,
    ColumnClass: EncryptedIntegerOrdColumn,
    castAs: 'number',
    capabilities: ORD,
    indexes: OPE_IDX,
    samples: INTEGER_S,
  ...
  'public.eql_v3_smallint': {
    builder: types.Smallint,
    ColumnClass: EncryptedSmallintColumn,
    castAs: 'number',
    capabilities: STORAGE,
    indexes: NONE,
    samples: SMALLINT_S,
  ...
  'public.eql_v3_smallint_eq': {
    builder: types.SmallintEq,
    ColumnClass: EncryptedSmallintEqColumn,
    castAs: 'number',
    capabilities: EQ,
    indexes: UNIQUE_IDX,
    samples: SMALLINT_S,
  ...
  'public.eql_v3_smallint_ord_ore': {
    builder: types.SmallintOrdOre,
    ColumnClass: EncryptedSmallintOrdOreColumn,
    castAs: 'number',
    capabilities: ORD,
    indexes: ORE_IDX,
    samples: SMALLINT_S,
  ...
  'public.eql_v3_smallint_ord': {
    builder: types.SmallintOrd,
    ColumnClass: EncryptedSmallintOrdColumn,
    castAs: 'number',
    capabilities: ORD,
    indexes: OPE_IDX,
    samples: SMALLINT_S,
  ...
  'public.eql_v3_bigint': {
    builder: types.Bigint,
    ColumnClass: EncryptedBigintColumn,
    castAs: 'bigint',
    capabilities: STORAGE,
    indexes: NONE,
    samples: BIGINT_S,
    errorSamples: BIGINT_ERR,
  },
  'public.eql_v3_bigint_eq': {
    builder: types.BigintEq,
    ColumnClass: EncryptedBigintEqColumn,
    castAs: 'bigint',
    capabilities: EQ,
    indexes: UNIQUE_IDX,
    samples: BIGINT_S,
  ...
  'public.eql_v3_bigint_ord_ore': {
    builder: types.BigintOrdOre,
    ColumnClass: EncryptedBigintOrdOreColumn,
    castAs: 'bigint',
    capabilities: ORD,
    indexes: ORE_IDX,
    samples: BIGINT_S,
  ...
  'public.eql_v3_bigint_ord': {
    builder: types.BigintOrd,
    ColumnClass: EncryptedBigintOrdColumn,
    castAs: 'bigint',
    capabilities: ORD,
    indexes: OPE_IDX,
    samples: BIGINT_S,
  ...
  'public.eql_v3_date': {
    builder: types.Date,
    ColumnClass: EncryptedDateColumn,
    castAs: 'date',
    capabilities: STORAGE,
    indexes: NONE,
    samples: DATE_S,
  ...
  'public.eql_v3_date_eq': {
    builder: types.DateEq,
    ColumnClass: EncryptedDateEqColumn,
    castAs: 'date',
    capabilities: EQ,
    indexes: UNIQUE_IDX,
    samples: DATE_S,
  ...
  'public.eql_v3_date_ord_ore': {
    builder: types.DateOrdOre,
    ColumnClass: EncryptedDateOrdOreColumn,
    castAs: 'date',
    capabilities: ORD,
    indexes: ORE_IDX,
    samples: DATE_S,
  ...
  'public.eql_v3_date_ord': {
    builder: types.DateOrd,
    ColumnClass: EncryptedDateOrdColumn,
    castAs: 'date',
    capabilities: ORD,
    indexes: OPE_IDX,
    samples: DATE_S,
  ...
  'public.eql_v3_timestamp': {
    builder: types.Timestamp,
    ColumnClass: EncryptedTimestampColumn,
    castAs: 'timestamp',
    capabilities: STORAGE,
    indexes: NONE,
    samples: TS_S,
  ...
  'public.eql_v3_timestamp_eq': {
    builder: types.TimestampEq,
    ColumnClass: EncryptedTimestampEqColumn,
    castAs: 'timestamp',
    capabilities: EQ,
    indexes: UNIQUE_IDX,
    samples: TS_S,
  ...
  'public.eql_v3_timestamp_ord': {
    builder: types.TimestampOrd,
    ColumnClass: EncryptedTimestampOrdColumn,
    castAs: 'timestamp',
    capabilities: ORD,
    indexes: OPE_IDX,
    samples: TS_S,
  ...
  'public.eql_v3_numeric': {
    builder: types.Numeric,
    ColumnClass: EncryptedNumericColumn,
    castAs: 'number',
    capabilities: STORAGE,
    indexes: NONE,
    samples: NUMERIC_S,
  ...
  'public.eql_v3_numeric_ord_ore': {
    builder: types.NumericOrdOre,
    ColumnClass: EncryptedNumericOrdOreColumn,
    castAs: 'number',
    capabilities: ORD,
    indexes: ORE_IDX,
    samples: NUMERIC_S,
  ...
  'public.eql_v3_numeric_ord': {
    builder: types.NumericOrd,
    ColumnClass: EncryptedNumericOrdColumn,
    castAs: 'number',
    capabilities: ORD,
    indexes: OPE_IDX,
    samples: NUMERIC_S,
  ...
  'public.eql_v3_text': {
    builder: types.Text,
    ColumnClass: EncryptedTextColumn,
    castAs: 'string',
    capabilities: STORAGE,
    indexes: NONE,
    samples: TEXT_S,
  ...
  'public.eql_v3_text_eq': {
    builder: types.TextEq,
    ColumnClass: EncryptedTextEqColumn,
    castAs: 'string',
    capabilities: EQ,
    indexes: UNIQUE_IDX,
    samples: TEXT_S,
  ...
  'public.eql_v3_text_match': {
    builder: types.TextMatch,
    ColumnClass: EncryptedTextMatchColumn,
    castAs: 'string',
  ...
  'public.eql_v3_text_ord_ore': {
    builder: types.TextOrdOre,
    ColumnClass: EncryptedTextOrdOreColumn,
    castAs: 'string',
    capabilities: ORD,
    indexes: TEXT_ORD_ORE_IDX,
    samples: TEXT_ORE_S,
    deferred: ORE_DEFERRED,
  },
  'public.eql_v3_text_ord': {
    builder: types.TextOrd,
    ColumnClass: EncryptedTextOrdColumn,
    castAs: 'string',
    capabilities: ORD,
    indexes: TEXT_ORD_IDX,
    samples: TEXT_ORE_S,
  },
  'public.eql_v3_text_search': {
    builder: types.TextSearch,
    ColumnClass: EncryptedTextSearchColumn,
    castAs: 'string',
    capabilities: FULL,
    indexes: TEXT_SEARCH_IDX,
    samples: TEXT_ORE_S,
  },
  // boolean
  'public.eql_v3_boolean': {
    builder: types.Boolean,
    ColumnClass: EncryptedBooleanColumn,
    castAs: 'boolean',
    capabilities: STORAGE,
    indexes: NONE,
    samples: BOOLEAN_S,
  ...
  'public.eql_v3_real': {
    builder: types.Real,
    ColumnClass: EncryptedRealColumn,
    castAs: 'number',
    capabilities: STORAGE,
    indexes: NONE,
    samples: REAL_S,
  ...
  'public.eql_v3_real_eq': {
    ...
    ColumnClass: EncryptedRealEqColumn,
    castAs: 'number',
    capabilities: EQ,
    indexes: UNIQUE_IDX,
    samples: REAL_S,
  ...
  'public.eql_v3_real_ord_ore': {
    builder: types.RealOrdOre,
    ColumnClass: EncryptedRealOrdOreColumn,
    castAs: 'number',
    capabilities: ORD,
    indexes: ORE_IDX,
    samples: REAL_S,
  ...
  'public.eql_v3_real_ord': {
    builder: types.RealOrd,
    ColumnClass: EncryptedRealOrdColumn,
    castAs: 'number',
    capabilities: ORD,
    indexes: OPE_IDX,
    samples: REAL_S,
  ...
  'public.eql_v3_double': {
    builder: types.Double,
    ColumnClass: EncryptedDoubleColumn,
    castAs: 'number',
    capabilities: STORAGE,
    indexes: NONE,
    samples: DOUBLE_S,
  ...
  'public.eql_v3_double_eq': {
    builder: types.DoubleEq,
    ColumnClass: EncryptedDoubleEqColumn,
    castAs: 'number',
    capabilities: EQ,
    indexes: UNIQUE_IDX,
    samples: DOUBLE_S,
  ...
  'public.eql_v3_double_ord_ore': {
    builder: types.DoubleOrdOre,
    ColumnClass: EncryptedDoubleOrdOreColumn,
    castAs: 'number',
    capabilities: ORD,
    indexes: ORE_IDX,
    samples: DOUBLE_S,
  ...
  'public.eql_v3_double_ord': {
    builder: types.DoubleOrd,
    ColumnClass: EncryptedDoubleOrdColumn,
    castAs: 'number',
    capabilities: ORD,
    indexes: OPE_IDX,
    samples: DOUBLE_S,
