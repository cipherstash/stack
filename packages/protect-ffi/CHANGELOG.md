...
- a2b0b45: Point the published metadata at `cipherstash/stack`, the repository these
...
- a2b0b45: Ship `CHANGELOG.md` inside the published tarball. It was missing from `files`,
